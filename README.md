...
*   **Structured Retrieval:** Извлечение эталона по ID задачи (основной сценарий).
*   **Semantic Search:** Поиск задач-аналогов по векторам (рекомендации).
...
### 5.2 Tone of Voice
Поддерживающий, наставнический, без панибратства.

---

## 6. Безопасность и этика
*   **Риск галлюцинаций:** Минимизируется жестким RAG-контекстом.
*   **Prompt Injection:** Защита от запросов "Скажи ответ".
